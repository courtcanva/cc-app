...
describe("ErrorMsg", () => {
  test("should not display error message when no validations occur", () => {
  ...
  test("should display correct error message when court name is null", () => {
    const userInputError: ITemplateErrorInput = {
      courtNameFullErr: false,
  ...
  test("should display correct error message when court name is full", () => {
    const userInputError: ITemplateErrorInput = {
