...
it("should render correct construction pdf source", () => {
  const previousState: ConstructionState = initialState;
  expect(reducer(previousState, changeConstructionPdfSrc("mockSrc"))).toEqual({
    ...previousState,
    constructionPdfSrc: "mockSrc",
  });
});
