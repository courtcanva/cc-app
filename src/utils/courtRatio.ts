...
const courtRatio = (courtData: ICourtRatioProps) => {
  ...
  courtData.windowHeight >= 768 ? (court.stageHeight = courtData.windowHeight - 250) : (court.stageHeight = 768 - 250);
  ...
  if ((courtData.windowHeight - 250) / (courtData.windowWidth - 118) > convasHeight / convasWidth) {
    courtData.windowWidth >= 768 ? (court.stageWidth = courtData.windowWidth - 118) : (court.stageWidth = 768 - 118);
