  ...
  useEffect(() => {
    if (selectedColor !== "none") {
      const svgIcon =
        ...
        `; fill: ` +
        fillColor +
        `; stroke-width: 1.4; stroke-dasharray: none; stroke-linecap: butt; stroke-dashoffset: 0; stroke-linejoin: miter; stroke-miterlimit: 4; is-custom-font: none; font-file-url: none; fill-rule: nonzero; opacity: 1;" vector-effect="non-scaling-stroke" transform=" translate(-11, -2.1665)" d="M 1.833 0.833 h 18.334 c 0.732 0 1.333 0.601 1.333 1.333 c 0 0.733 -0.601 1.334 -1.333 1.334 H 1.833 A 1.339 1.339 0 0 1 0.5 2.166 c 0 -0.732 0.601 -1.333 1.333 -1.333 z" stroke-linecap="round"/>
        </g>
      </svg>`;
      const iconUrl =
