    ...
    return (
        <Box as="button" role="group" w="full" marginTop="1" marginRight="4" key={court.id}>
          <Flex flexDirection="column" align="center" justify="flex-start">
            <Icon width="40px" height="40px" boxShadow="0.5px 1px 3px grey" viewBox="0 0 20 36" p="2px" _groupHover={{ outline: "3px solid grey" }} color="fontcolor.primary" _groupActive={{ outline: "3px solid black" }}>
              {court.icon}
            </Icon>
            <Text
              marginTop="1"
...
const CourtTemplate: React.FC = () => {
  return (
    <>
      ...
      >
        <CourtInfo />  
        <Box as="button" role="group" w="40px" marginTop="5.5px" marginRight="4" height="40px" bg="#c7c5c5">
            <Icon width="40px" height="40px" viewBox="0 0 50 50" p="13px" _groupHover={{ outline: "3px solid grey" }} color="fontcolor.primary" _groupActive={{ outline: "3px solid black" }}>
              <Addcourt />
            </Icon>
        </Box>                      
      </Box>
